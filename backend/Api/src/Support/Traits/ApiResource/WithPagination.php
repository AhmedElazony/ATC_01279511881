...
namespace Api\Support\Traits\ApiResource;
            ...
            public function toArray($request): array
            {
                return [
                    ...
                    'paginate' => [
                        ...
                        'next_page_url' => Str::replace(config('app.url'), '', $this->nextPageUrl()) ?? '',
                        'prev_page_url' => Str::replace(config('app.url'), '', $this->previousPageUrl()) ?? '',
